...
<div id="heading-block">
                <h2><a name="prod">SOLD ITEMS</a></h2>
            </div>
...
$qry = ("SELECT * FROM sold WHERE username = '$usr'");
$result = mysqli_query($db,$qry);
                ...
                echo  '<div class="prod-feature">';
                 ...
                 <a style="color:black;" href="deletead.php?id1=<?php echo $row['id'] ?>"><input type="button" value="Delete Ad" ></a>
                  ...
                  <a style="color:black;" href="resell.php?id4=<?php echo $row['id'] ?>"><input type="button" value="Re-Sell" ></a>
<?php
